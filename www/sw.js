const CACHE='zinciri-product-v3-practices';
const FILES=['./','./index.html','./native-bridge.bundle.js','./product.css','./product-i18n.js','./locales/en.js','./product-validation.js','./product.js','./product-modules.js','./product-practices.js','./manifest.webmanifest','./assets/Manrope.ttf','./assets/icon-192.png','./assets/icon-512.png','./assets/icon-maskable.png'];
